...
import psycopg2  # Para conectar com o banco de dados PostgreSQL
import tkinter as tk  # Para criar a interface gráfica
from tkinter import messagebox, ttk  # Componentes extras do Tkinter
from faker import Faker  # Para gerar dados fictícios (nomes e matrículas)
import random  # Para gerar notas aleatórias
